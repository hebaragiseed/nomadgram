...
export const SignupForm = props => (
  <div className={styles.formComponent}>
    <h3 className={styles.signupHeader}>Sign up to see photos and videos from yor friends.</h3>
    ...
    <form className={styles.form}>
      ...
      <input className={styles.textInput} type="password" placeholder='Password' />
      <input className={styles.textInput} type="submit" placeholder='Sign up' />
    </form>
    <p className={styles.terms}>
      By siging up, you agree to our<span> Terms & Privacy Policy</span>.
    </p>
  </div>
);
